...
if [ ! -f "mesa-${mesaversion}.tar.gz" ]; then
    ...
    echo "https://gitlab.freedesktop.org/mesa/mesa-releases/-/raw/master/mesa-${mesaversion}.tar.gz"
    curl $curlopts -O "https://gitlab.freedesktop.org/mesa/mesa-releases/-/raw/master/mesa-${mesaversion}.tar.gz"
...
if [ ! -f glu-${gluversion}.tar.bz2 ]; then
    ...
    curl $curlopts -O "http://gitlab.freedesktop.org/mesa/mesa-releases/-/raw/master/glu/glu-${gluversion}.tar.bz2"
fi
